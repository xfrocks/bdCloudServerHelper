...
// updated by DevHelper_Helper_ShippableHelper at 2016-12-02T06:55:38+00:00

/**
 * Class bdCloudServerHelper_ShippableHelper_Updater
 * @version 7
...
class bdCloudServerHelper_ShippableHelper_Updater
{
    ...
    public static function onInitDependencies(
        ...
        $GLOBALS[self::KEY]['version'][$apiUrl][self::$_version]
            = 'bdCloudServerHelper_ShippableHelper_UpdaterCore';
    ...
    public static function onUninstall($apiUrl = null, $addOnId = null)
    {
        ...
        if (empty($activeAddOnIds)) {
            ...
            bdCloudServerHelper_ShippableHelper_UpdaterCore::_uninstallSelf($apiUrl);
        }
    }
